                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <form class="form-horizontal" action="{{ route('materi.update', $materi->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="content">{{ $materi->content }}</textarea>
                                            <div class="invalid-feedback">
                                                Masukan Isi
                                            </div>
                                        </div>
